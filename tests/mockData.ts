...
export const mockCharacter1: Character = {
  ...
  type: "",
  gender: "Male",
  origin: { name: "Earth (C-137)", type: "Planet" },
  location: { name: "Earth (Replacement Dimension)", type: "Planet" },
...
export const mockCharacter2: Character = {
  ...
  type: "",
  gender: "Female",
  origin: { name: "Test Origin", type: "Planet" },
  location: { name: "Test Location", type: "Planet" },
